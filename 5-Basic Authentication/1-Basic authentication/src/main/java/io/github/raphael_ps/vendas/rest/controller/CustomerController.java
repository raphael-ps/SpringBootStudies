...
public class CustomerController {
    ...
    public Customer registerCustomer(@RequestBody @Valid Customer newCustomer){
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void updateCustomer(@PathVariable("id") Integer customerId, @RequestBody @Valid Customer customerUpdated){
